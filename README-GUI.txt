...
Mac OS X or Ubuntu GNU/Linux installation ]

There are two graphic user interfaces:
1) RubyCocoa based - csv2uppaal.dmg (installer for Mac OS X)
2) Tk based - tklauncher.rb (to be run on Linux distributions)
...
GUI for Ubuntu (and other linux) users. 

Make sure you have ruby, Tk and the Ruby-Tk binding available by running:
